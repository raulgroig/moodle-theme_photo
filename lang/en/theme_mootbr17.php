...
$string['choosereadme'] = 'Theme mootbr17 is a child theme of Boost. It adds the ability to upload background mootbr17s.';
// Name of the settings pages.
$string['configtitle'] = 'mootbr17 settings';
